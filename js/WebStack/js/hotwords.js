...
$(function() {
    $(document).on("click", ".website-notice",
    function() {
...
function search() {
                ...
                if (hotList) {
                    ...
                    for (var i = 0; i < hotList; i++) {
                        ...
                        $("#box ul li").eq(i).click(function() {
                            ...
                            $("#search-text").val(thisText);
                            /* window.open(searchData.thisSearch + thisText); */
                            document.getElementById("s-btn").click();/* 硬凑的代码，无效多但是功能没问题哦 */
    ...
    $("#search-text").keydown(function(e) {
        ...
        if (e.keyCode === 13) {
            /* window.open(searchData.thisSearch + $("#search-text").val()); */
            document.getElementById("s-btn").click();/* 硬凑的代码，无效多但是功能没问题哦 */
            $("#box").css("display", "none");
            $("#search-text").blur();
...
$(document).on("click", ".login-register a",
function() {
    layer.close(loginLayer);
    registerLayer = layer.open(layerRegisterLayer)
});
function mobileUser() {
    $(".mobile-user").on("click", "#mobile-login",
    function() {
        layer.open(layerObj)
    });
    $(".mobile-user").on("click", "#mobile-register",
    function() {
...
$(".mobile-user").on("click", "#user-btn",
function(event) {
    if (event.target.offsetParent == this) {
        $("#user-btn").toggleClass("show-user-btn")
    }
});
$(".mobile-user").on("click", ".user-btn-group li",
function() {
    var index = $(this).index();
    $("#user-btn").toggleClass("show-user-btn");
    if (index === 0) {
...
$(".theme, #cancel, #cancel-x, .zhezhao-bg").on("click",
function() {
