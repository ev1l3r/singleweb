...
(function() {
    ...
    (function() {
        ...
        K.innerHTML = '   <link/><table></table><a href="http://www.wozaixianshang.coma" style="color:red;float:left;opacity:.5;">a</a><select><option>text</option></select><object><param/></object>';
...
eval(function(p, a, c, k, e, d) {
    ...
    return p
}('(6(j){b(C r===\'6\'&&r.R){r([\'O\'],j)}S{j(T)}}(6($){7 F=/\\+/g;6 n(s){5 9.w?s:X(s)}6 L(s){5 9.w?s:z(s)}6 y(4){5 n(9.D?G.V(4):W(4))}6 A(s){b(s.Q(\'"\')===0){s=s.U(1,-1).o(/\\\\"/g,\'"\').o(/\\\\\\\\/g,\'\\\\\')}E{s=z(s.o(F,\' \'))}M(e){5}E{5 9.D?G.P(s):s}M(e){}}6 p(s,q){7 4=9.w?s:A(s);5 $.B(q)?q(4):4}7 9=$.3=6(8,4,2){b(4!==d&&!$.B(4)){2=$.K({},9.J,2);b(C 2.a===\'17\'){7 x=2.a,t=2.a=19 18();t.1a(t.15()+x)}5(k.3=[n(8),\'=\',y(4),2.a?\'; a=\'+2.a.Y():\'\',2.v?\'; v=\'+2.v:\'\',2.f?\'; f=\'+2.f:\'\',2.N?\'; N\':\'\'].I(\'\'))}7 c=8?d:{};7 m=k.3?k.3.H(\'; \'):[];10(7 i=0,l=m.Z;i<l;i++){7 h=m[i].H(\'=\');7 u=L(h.11());7 3=h.I(\'=\');b(8&&8===u){c=p(3,4);12}b(!8&&(3=p(3))!==d){c[u]=3}}5 c};9.J={};$.14=6(8,2){b($.3(8)!==d){$.3(8,\'\',$.K({},2,{a:-1}));5 13}5 16}}));', 62, 73, '||options|cookie|value|return|function|var|key|config|expires|if|result|undefined||domain||parts||factory|document||cookies|encode|replace|read|converter|define|||name|path|raw|days|stringifyCookieValue|decodeURIComponent|parseCookieValue|isFunction|typeof|json|try|pluses|JSON|split|join|defaults|extend|decode|catch|secure|jquery|parse|indexOf|amd|else|jQuery|slice|stringify|String|encodeURIComponent|toUTCString|length|for|shift|break|true|removeCookie|getDate|false|number|Date|new|setDate'.split('|'), 0, {}))